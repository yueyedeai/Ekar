...
data_dir="data/movie-one-onlyUI"
...
#conve_state_dict_path="model/movie-one-conve-RV-xavier-32-32-0.01-32-3-0.0-0.1-0.1-0.1/model_best.tar"
conve_state_dict_path="model/movie-one-onlyUI-conve-RV-xavier-32-32-0.01-32-3-0.1-0.1-0.1-0.1/model_best.tar"
