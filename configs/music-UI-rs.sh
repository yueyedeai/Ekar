...
baseline="n/a"
grad_norm=5
emb_dropout_rate=0.2 # 0.1
ff_dropout_rate=0.2 # 0.1
action_dropout_rate=0.2 # 0.1
...
conve_state_dict_path="model/music-conve-RV-xavier-32-32-0.01-32-3-0.2-0.1-0.1-0.1/model_best.tar"
