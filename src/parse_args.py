...
parser.add_argument('--test_metrics', action='store_true',
                    help='test metrics (default: False)')
...
# Knowledge Graph
parser.add_argument('--interact_relation', type=str)
...
parser.add_argument('--emb_2D_d2', type=int, default=8,
                    help='ConvE embedding 2D shape dimension 2 (default: 8)')
...
parser.add_argument('--entity_history', action='store_true')
