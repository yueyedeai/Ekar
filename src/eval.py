...
# def NDCG_and_Precision_debug(examples, scores, all_answers, item_set, verbose=False, phase="test"):
#     """
#     Compute ranking based metrics.
#     """
#     assert (len(examples) == scores.shape[0])
...
#         # write back the save prediction
#         scores[i, e2] = target_score
#         # if phase == "debug" and i <= 3:
#         #     print (e1, e2, r)
#         #     print ("item_list", item_list)
#         #     print ("item_score", item_score)
#         #     print ("target_score", target_score)
#         #     print ("e2_multi(mask)", e2_multi)
#         #     print ("score after mask", scores[i])
#     average_arrive /= len(examples)
#     average_answer /= len(examples)
#
#     K = np.array([5, 10, 20])
...
#                     if rk <= K[k]:
#                         Precision[k] += 1.0 / K[k]
#                         DCG[k]       += 1.0 / np.log2(1 + rk)
#             if j < len(e2_set):
#                 for k in range(len(K)):
#                     if rk <= K[k]:
#                         IDCG[k]      += 1.0 / np.log2(1 + rk)
#         NDCG = NDCG + DCG / IDCG
#
#     NDCG /= len(examples)
#     Precision /= len(examples)
